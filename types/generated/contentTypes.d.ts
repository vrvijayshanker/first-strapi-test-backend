...
export interface ApiHomepageSectionHomepageSection
  ...
  attributes: {
    HomeCarousel: Attribute.Component<'page-sections.carousel-images', true>;
    Header: Attribute.Component<'page-sections.header-custom'>;
    Nav: Attribute.Component<'page-sub-sections.nav-menu', true>;
    abouttest: Attribute.Component<'page-sections.about-section'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
